...
| `handle_business3()`  | 고급자용   | 경쟁사 분석, IR 내용 포함한 심층 분석 |
...
| 함수명               | 챗봇 레벨 | 설명 |
|--------------------|-----------|------|
| `handle_hybrid1()`  | 초급자용   | 회계, 재무, 사업 중 하나라도 매칭되면 응답 |
| `handle_hybrid2()`  | 중급자용   | 2개 이상 정보를 연결한 통합 분석 |
| `handle_hybrid3()`  | 고급자용   | 모든 정보를 종합해 고도화된 답변 생성 |
